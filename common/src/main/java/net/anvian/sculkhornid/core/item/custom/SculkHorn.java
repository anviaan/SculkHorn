...
public abstract class SculkHorn extends Item {
    ...
    @Override
    public abstract void appendHoverText(ItemStack pStack, Level level, List<Component> pTooltipComponents, TooltipFlag pTooltipFlag);
    ...
    protected void applyCooldownToBothHorns(Player player) {
        player.getCooldowns().addCooldown(ModItems.SCULKHORN.asItem(), ModConfigs.areaCooldown);
        player.getCooldowns().addCooldown(ModItems.SCULKHORN_SONICBOOM.asItem(), ModConfigs.distanceCooldown);
    }
}
